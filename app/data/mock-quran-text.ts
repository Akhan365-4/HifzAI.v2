/**
 * Mock Quran page text for development.
 * Each page maps to an array of 15 strings (one per line).
 * These are NOT exact mushaf line breaks — placeholder content
 * for layout testing only. Replace with real data source later.
 */

export const mockPageText: Record<number, string[]> = {
  1: [
...
export function getPageText(pageNumber: number): string[] | null {
  return mockPageText[pageNumber] ?? null;
}
